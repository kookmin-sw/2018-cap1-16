...
if __name__ == '__main__' :
    ...
    if argv_cnt != 2 :
        ...
        print("python make_idb_func_fops.py <directory> : <directory> 하위에 있는 모든 파일에 대한 idb(i64) 파일과 ffops파일을 추출" )
        print("python make_idb_func_fops.py <file> : <file>에 대해 idb(i64) 파일과 ffops파일을 추출")
    if argv_cnt == 2 :
        path = sys.argv[1]
